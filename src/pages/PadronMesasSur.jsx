...
import usePadronDataSur from '../hooks/usePadronDataSur';
...
const PadronMesasSur = () => {
  const { localities, mesaData, totalLocalidad, localidadName, loading, error, loadMesaData, localityFileMap } = usePadronDataSur();
